const displayName = 'Shadaakshari Kalagara'
const bannerDescription = 'Enthusiastic Student Developer and eternal learner'
const mediumUrl = ''
const mediumFilterKeyword = 'technology'
const email = 'shadaakshari19@gmail.com'
const githubUrl = "https://github.com/shadaakshari-Kalagara"
const linkedInUrl = "https://www.linkedin.com/in/shadaakshari-kalagara-47a9781b4/"


const projects = [
    {
        title: 'PhishGen',
        description: 'A phishing detection web application that helps the user for safe browsing',
    ...
    },
    {
        ...
        description: 'An online doodling white board that can be used and by many users simultaneously.',
...
export { projects,articles, mediumUrl, mediumFilterKeyword, email, githubUrl, linkedInUrl, displayName, bannerDescription }